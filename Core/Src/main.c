...
#define  QUEUE_LEN    1   /* Â¶Ã“ÃÃÂµÃ„Â³Â¤Â¶ÃˆÂ£Â¬Ã—Ã®Â´Ã³Â¿Ã‰Â°Ã¼ÂºÂ¬Â¶Ã Ã‰Ã™Â¸Ã¶ÃÃ»ÃÂ¢ */
#define  QUEUE_SIZE   1   /* Â¶Ã“ÃÃÃ–ÃÃƒÂ¿Â¸Ã¶ÃÃ»ÃÂ¢Â´Ã³ÃÂ¡Â£Â¨Ã—Ã–Â½ÃšÂ£Â© */
 ...
 *        º¯ÊýÉùÃ÷
**************************************************************************/
void AppTaskCreate(void);/* ÓÃÓÚ´´½¨ÈÎÎñ */

void Led_Task(void* pvParameters);/* Led_TaskÈÎÎñÊµÏÖ */
void KEY_Task(void* pvParameters);/* KEY_TaskÈÎÎñÊµÏÖ */
...
int main(void)
{
  ...
  //ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Ê¼ï¿½ï¿½ï¿½ï¿½
   xTaskCreate((TaskFunction_t )AppTaskCreate,            //ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½
                ...
                (TaskHandle_t*  )&AppTaskCreate_Handle);   //ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½   
...
/***********************************************************************
  * @ ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½  ï¿½ï¿½ AppTaskCreate
  * @ ï¿½ï¿½ï¿½ï¿½Ëµï¿½ï¿½ï¿½ï¿½ Îªï¿½Ë·ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Ðµï¿½ï¿½ï¿½ï¿½ñ´´½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½
  * @ ï¿½ï¿½ï¿½ï¿½    ï¿½ï¿½ ï¿½ï¿½  
  * @ ï¿½ï¿½ï¿½ï¿½Öµ  ï¿½ï¿½ ï¿½ï¿½
  **********************************************************************/
void AppTaskCreate(void)
{
  BaseType_t xReturn = pdPASS;/* ï¿½ï¿½ï¿½ï¿½Ò»ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Ï¢ï¿½ï¿½ï¿½ï¿½Öµï¿½ï¿½Ä¬ï¿½ï¿½ÎªpdPASS */
  ...
  xReturn = xTaskCreate((TaskFunction_t )KEY_Task,  /* ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Úºï¿½ï¿½ï¿½ */
                        ...
                        (uint16_t       )KEY_STK_SIZE,  /* ï¿½ï¿½ï¿½ï¿½Õ»ï¿½ï¿½Ð¡ */
                        (void*          )NULL,/* ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Úºï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ */
                        (UBaseType_t    )3, /* ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½È¼ï¿½ */
                        (TaskHandle_t*  )&KEY_Task_Handle);/* ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Æ¿ï¿½Ö¸ï¿½ï¿½ */ 
  if(pdPASS == xReturn)
    printf("KEY_Task success\r\n");
                        
  /* ï¿½ï¿½ï¿½ï¿½Test_Taskï¿½ï¿½ï¿½ï¿½ */
  xReturn = xTaskCreate((TaskFunction_t )Led_Task, /* ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Úºï¿½ï¿½ï¿½ */
                        (const char*    )"Led_Task",/* ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ */
                        (uint16_t       )LED0_STK_SIZE,    /* ï¿½ï¿½ï¿½ï¿½Õ»ï¿½ï¿½Ð¡ */
                        (void*          )NULL,	/* ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Úºï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ */
                        (UBaseType_t    )2,	    /* ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½È¼ï¿½ */
                        (TaskHandle_t*  )&Led_Task_Handle);/* ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Æ¿ï¿½Ö¸ï¿½ï¿½ */
...
/**********************************************************************
  * @ ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½  ï¿½ï¿½ Test_Task
  * @ ï¿½ï¿½ï¿½ï¿½Ëµï¿½ï¿½ï¿½ï¿½ Test_Taskï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½
  * @ ï¿½ï¿½ï¿½ï¿½    ï¿½ï¿½   
  * @ ï¿½ï¿½ï¿½ï¿½Öµ  ï¿½ï¿½ ï¿½ï¿½
  ********************************************************************/
...
{	
  ...
  while (1)
  {
      ...
      vTaskDelay(1000);   /* ï¿½ï¿½Ê±500ï¿½ï¿½tick */
 ...
 BaseType_t xReturn = pdPASS;/* define return of value ,defualt value pdPASS */
  ...
  while (1)
  {
    ...
    if(tpd_t.read_key_value!=0){
        vTaskSuspend(Led_Task_Handle);/* Â»Ã–Â¸Â´LEDÃˆÃŽÃŽÃ±Â£Â¡ */
    ...
    if(tpd_t.run_process_tag==KEY_NULL){
        ...
        vTaskResume(Led_Task_Handle);/* Â»Ã–Â¸Â´LEDÃˆÃŽÃŽÃ±Â£Â¡ */
